import { MessageSquare, Layers, Target, GraduationCap, Star, HelpCircle } from "lucide-react";
import { SEO } from "../../components/SEO";
import { Button } from "../../components/ui/Button";

export default function ConsapevolezzaDocenti() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": "Corso di Formazione Educazione Civica Digitale per Insegnanti",
    "description": "Corso di formazione per docenti su cittadinanza digitale, IA e cyberbullismo. Impara a guidare i ragazzi nel mondo online.",
    "provider": {
      "@type": "Organization",
      "name": "Digital Heroes",
  ...
  return (
    <div className="w-full flex-1 flex flex-col gap-20 md:gap-28 p-4 sm:p-8 md:p-12 lg:p-16 bg-brand-bg text-[#1a1025]">
      <SEO
        title="Corso di Formazione Educazione Civica Digitale per Insegnanti | Digital Heroes"
        description="Impari a trattare temi come l'IA, i social network e il cyberbullismo in classe, per formare cittadini digitali consapevoli."
        jsonLd={jsonLd}
      />
      ...
      <section className="relative bg-white border-2 border-brand-secondary p-8 sm:p-16 md:p-20 rounded-3xl shadow-[6px_6px_0_0_#1a1025] flex flex-col items-center text-center overflow-hidden mt-28 md:mt-36 max-w-6xl mx-auto w-full">
        <div className="relative z-10 max-w-4xl space-y-8 flex flex-col items-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase leading-[1.05] tracking-tight text-[#1a1025]">
            Insegna l'educazione civica digitale in autonomia
          </h1>
          
          <p className="text-lg md:text-xl font-medium max-w-2xl mx-auto text-[#1a1025]/80">
            Acquisisci le competenze per strutturare lezioni efficaci sull'educazione civica digitale. Diventa autonomo nell'affrontare temi complessi come IA, cyberbullismo e identità online con le tue classi.
          </p>
      ...
      {/* Perché formarti sull'Educazione Civica Digitale */}
      <section className="max-w-6xl mx-auto w-full space-y-12">
        <div className="text-center md:text-left border-b-2 border-brand-secondary pb-6">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black uppercase tracking-tight text-[#1a1025]">
            Perché formarti su questo tema
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            {
              title: "Padronanza delle tematiche",
              desc: "Aggiornati su Intelligenza Artificiale, fake news, algoritmi e le nuove sfide dei social network.",
              icon: <MessageSquare className="w-8 h-8 text-[#10b981]" />
            },
            {
              title: "Progettazione didattica",
              desc: "Capisci come costruire percorsi di educazione civica chiari, efficaci e privi di moralismi.",
              icon: <Target className="w-8 h-8 text-orange-500" />
            },
            {
              title: "Gestione del dibattito",
              desc: "Tecniche per stimolare il confronto in classe, gestire i temi delicati come il cyberbullismo e favorire l'espressione.",
              icon: <Layers className="w-8 h-8 text-blue-500" />
            },
            {
              title: "Versatilità Umanistica e Scientifica",
              desc: "Integra i temi digitali in lettere, educazione civica, storia o scienze. Un approccio trasversale per ogni materia.",
              icon: <GraduationCap className="w-8 h-8 text-yellow-500" />
            }
          ].map((item, idx) => (
            <div key={idx} className="bg-white text-[#1a1025] border-2 border-brand-secondary p-8 rounded-2xl shadow-[4px_4px_0_0_#1a1025] hover:-translate-y-1 hover:shadow-[6px_6px_0_0_#10b981] transition-all flex flex-col gap-4">
      ...
      <section className="max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="grid grid-cols-1 gap-6">
          {[
            {
              title: "Le basi dell'ecosistema digitale",
              desc: "Esploriamo insieme i concetti chiave: IA generativa, dinamiche social, cyber security e identità online."
            },
            {
              title: "Costruisci la tua attività",
              desc: "Scegliamo un tema (es. contrasto al cyberbullismo) e strutturiamo un'attività didattica con format interattivi."
            },
            {
              title: "Simulazione e feedback",
              desc: "Analizziamo scenari complessi in classe e capiamo come moderare le discussioni senza fare lezioni frontali noiose."
            }
          ].map((step, idx) => (
            <div key={idx} className="bg-white text-[#1a1025] border-2 border-brand-secondary p-6 sm:p-8 rounded-2xl shadow-[4px_4px_0_0_#1a1025] flex flex-col sm:flex-row gap-6 items-start hover:-translate-y-1 hover:shadow-[6px_6px_0_0_#10b981] transition-all">
              <div className="w-12 h-12 shrink-0 bg-[#10b981] text-white font-black text-xl border-2 border-brand-secondary rounded-xl flex items-center justify-center shadow-[2px_2px_0_0_#1a1025]">
                {idx + 1}
              </div>
              <div>
      ...
      <section className="max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {["Progettazione di attività", "Gestione del dibattito", "Conoscenza dell'IA applicata", "Strumenti anti-cyberbullismo", "Materiali pronti all'uso"].map((tag, idx) => (
      ...
      {/* Recensione (Rotazione: Nicola) */}
      <section className="max-w-3xl mx-auto w-full">
        <div className="bg-white border-2 border-brand-secondary p-8 sm:p-10 rounded-2xl shadow-[4px_4px_0_0_#1a1025] hover:-translate-y-1 hover:shadow-[6px_6px_0_0_#10b981] transition-all">
          ...
          <p className="text-xl md:text-2xl font-bold text-[#1a1025]/90 italic text-center mb-6 leading-relaxed">
            "Mi è piaciuto moltissimo: è stato divertente ed educativo. Ho scoperto un sacco di cose nuove che non sapevo!"
          </p>
      ...
      <section className="max-w-4xl mx-auto w-full space-y-8">
        ...
        <div className="space-y-6">
          {[
            {
              q: "Devo essere un esperto di informatica per partecipare?",
              a: "Assolutamente no. Il corso è strutturato per fornire a qualsiasi docente le chiavi di lettura necessarie per comprendere i fenomeni digitali."
            },
            {
            ...
            <div key={idx} className="bg-white border-2 border-brand-secondary p-6 rounded-2xl shadow-[2px_2px_0_0_#1a1025] flex gap-4 items-start hover:-translate-y-1 hover:shadow-[4px_4px_0_0_#10b981] transition-all">
      ...
      <section className="max-w-4xl mx-auto w-full text-center pb-12">
        <div className="bg-[#f0fff4] border-2 border-brand-secondary p-8 sm:p-12 rounded-3xl shadow-[6px_6px_0_0_#1a1025]">
          ...
          <p className="text-lg font-medium text-[#1a1025]/80 mb-8 max-w-2xl mx-auto">
            Diventa autonomo nell'insegnamento dell'Educazione Civica Digitale.
          </p>
