import { Gamepad2, Layers, Target, GraduationCap, Star, HelpCircle } from "lucide-react";
import { SEO } from "../../components/SEO";
import { Button } from "../../components/ui/Button";

export default function MinecraftDocenti() {
  const jsonLd = {
    "@context": "https://schema.org",
    "@type": "Course",
    "name": "Corso di Formazione Minecraft Education per Insegnanti",
    "description": "Corso di formazione per docenti su Minecraft Education. Impara a usare il gioco come strumento didattico in autonomia.",
    "provider": {
      "@type": "Organization",
      "name": "Digital Heroes",
  ...
  return (
    <div className="w-full flex-1 flex flex-col gap-20 md:gap-28 p-4 sm:p-8 md:p-12 lg:p-16 bg-brand-bg text-[#1a1025]">
      <SEO
        title="Corso di Formazione Minecraft Education per Insegnanti | Digital Heroes"
        description="Impari a usare Minecraft Education come strumento didattico, così da poterlo portare nelle tue classi quando vuoi, in totale autonomia."
        jsonLd={jsonLd}
      />
      ...
      <section className="relative bg-white border-2 border-brand-secondary p-8 sm:p-16 md:p-20 rounded-3xl shadow-[6px_6px_0_0_#1a1025] flex flex-col items-center text-center overflow-hidden mt-28 md:mt-36 max-w-6xl mx-auto w-full">
        <div className="relative z-10 max-w-4xl space-y-8 flex flex-col items-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-black uppercase leading-[1.05] tracking-tight text-[#1a1025]">
            Impara a usare Minecraft Education in autonomia
          </h1>
          
          <p className="text-lg md:text-xl font-medium max-w-2xl mx-auto text-[#1a1025]/80">
            Acquisisci le competenze per integrare Minecraft Education nella tua didattica. Diventa autonomo nella progettazione delle lezioni e coinvolgi le tue classi senza bisogno di supporto esterno.
          </p>
      ...
      {/* Perché formarti su Minecraft Education */}
          ...
          {[
            {
              ...
              desc: "Impari l'interfaccia, le modalità didattiche e come strutturare un'attività efficace.",
              icon: <Gamepad2 className="w-8 h-8 text-[#cc7cf7]" />
            },
            {
              title: "Progettazione didattica",
              desc: "Capisci come costruire obiettivi di apprendimento chiari attorno al gioco.",
              icon: <Target className="w-8 h-8 text-blue-500" />
            },
            {
              title: "Gestione dei gruppi in aula",
              desc: "Tecniche per coordinare la classe, gestire i tempi e mantenere l'attenzione focalizzata sull'obiettivo.",
              icon: <Layers className="w-8 h-8 text-emerald-500" />
            },
            {
              title: "Versatilità Multidisciplinare",
              desc: "Adattabile a qualsiasi materia: matematica, fisica, chimica, storia o programmazione. Uno strumento flessibile per ogni docente.",
              icon: <GraduationCap className="w-8 h-8 text-yellow-500" />
            }
          ].map((item, idx) => (
            <div key={idx} className="bg-white text-[#1a1025] border-2 border-brand-secondary p-8 rounded-2xl shadow-[4px_4px_0_0_#1a1025] hover:-translate-y-1 hover:shadow-[6px_6px_0_0_#cc7cf7] transition-all flex flex-col gap-4">
      ...
      <section className="max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="grid grid-cols-1 gap-6">
          {[
            {
              title: "Le basi di Minecraft Education",
              desc: "Impari a muoverti nell'ambiente, le funzioni principali e gli strumenti pensati per la didattica."
            },
            {
              title: "Costruisci la tua attività",
              desc: "Con il nostro educatore, prepari un'attività concreta da usare con la tua classe."
            },
            {
            ...
            <div key={idx} className="bg-white text-[#1a1025] border-2 border-brand-secondary p-6 sm:p-8 rounded-2xl shadow-[4px_4px_0_0_#1a1025] flex flex-col sm:flex-row gap-6 items-start hover:-translate-y-1 hover:shadow-[6px_6px_0_0_#cc7cf7] transition-all">
              <div className="w-12 h-12 shrink-0 bg-[#cc7cf7] text-white font-black text-xl border-2 border-brand-secondary rounded-xl flex items-center justify-center shadow-[2px_2px_0_0_#1a1025]">
                {idx + 1}
              </div>
              <div>
      ...
      <section className="max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {["Uso autonomo della piattaforma", "Progettazione di attività", "Gestione dei gruppi in aula", "Valutazione degli obiettivi", "Materiali pronti all'uso"].map((tag, idx) => (
      ...
      <section className="max-w-3xl mx-auto w-full">
        <div className="bg-white border-2 border-brand-secondary p-8 sm:p-10 rounded-2xl shadow-[4px_4px_0_0_#1a1025] hover:-translate-y-1 hover:shadow-[6px_6px_0_0_#cc7cf7] transition-all">
      ...
      <section className="max-w-4xl mx-auto w-full space-y-8">
        ...
        <div className="space-y-6">
          {[
            {
              q: "Devo avere già esperienza con Minecraft per iscrivermi?",
              a: "No, il corso parte da zero. Non serve aver mai usato il gioco prima."
            },
            {
            ...
            <div key={idx} className="bg-white border-2 border-brand-secondary p-6 rounded-2xl shadow-[2px_2px_0_0_#1a1025] flex gap-4 items-start hover:-translate-y-1 hover:shadow-[4px_4px_0_0_#cc7cf7] transition-all">
      ...
      <section className="max-w-4xl mx-auto w-full text-center pb-12">
        <div className="bg-[#f0f8ff] border-2 border-brand-secondary p-8 sm:p-12 rounded-3xl shadow-[6px_6px_0_0_#1a1025]">
          ...
          <p className="text-lg font-medium text-[#1a1025]/80 mb-8 max-w-2xl mx-auto">
            Diventa autonomo nell'uso di Minecraft Education nelle tue classi.
          </p>
